...
module.exports = class lineMsgApi {
  /** *************************************************************************************
   * 初期設定
   * --------------------------------------------------------------------------------------
  ...
  constructor(params) {
    ...
    this.channelSecret = params.channelSecret;
  }
   ...
   * リプライメッセージ
   * ----------------------------------------------------------------------------
   * @param {string} params.token   - 【必須】リプライトークン
   * @param {array} params.messages - 【必須】メッセージボディ
   * @param {boolean} params.notificationDisabled - 通知無効
   =========================================================================== */
  async sendReplyMessage(params) {
    this.action = 'sendReplyMessage';
   ...
   * 当月のメッセージ数取得（前日まで）
   =========================================================================== */
  async getMessagesForMonth() {
    this.action = 'getNumberOfMessagesForMonth';
    return await this.axios_execution(null);
  }
  ...
  async createRichmenu(menuObj) {
    ...
    return await this.axios_execution(menuObj);
  }
  ...
  async uploadRichmenuImage(richMenuId, image) {
    ...
    data.append('richMenuId', richMenuId);
    data.append('image',      image);
    return await this.axios_execution(data);
  }
   ...
   * @param {string} richMenuId - 【必須】リッチメニューID
   =========================================================================== */
  async getRichmenus(richMenuId) {
    this.action = 'getRichmenus';
    return await this.axios_execution({
      richMenuId: richMenuId,
    });
  }
   ...
   * @param {string} richMenuId - 【必須】リッチメニューID
   =========================================================================== */
  async getDefaultRichmenuId(richMenuId) {
    this.action = 'getDefaultRichmenuId';
    return await this.axios_execution({
      richMenuId: richMenuId,
    });
  }
